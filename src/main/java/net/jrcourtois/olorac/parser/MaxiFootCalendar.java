 ...
 * @author jrc
 */
public class MaxiFootCalendar implements ChampionshipParser {
     ...
     * The host url.
     */
    private static final String HOSTURL = "http://www.maxifoot.fr/";

    /**
     * Constructor.
     */
    public MaxiFootCalendar() {
        myCalendar = new Calendar(new Ligue1());
    }
     ...
     */
    public MaxiFootCalendar(final String page) {
        myCalendar = new Calendar(new Ligue1());
        getMaxiFootCalendar(HOSTURL + page);
    }
     ...
     */
    public final void getMaxiFootCalendar(final String urlString) {
        try {
            URL url;
    ...
    protected final Match parseLine(final String line)
        ...
        for (String teamName : strings) {
            if (!teamName.isEmpty()) {
                ...
                if (t == null && t2 == null) {
                    t = new Team(teamName, new Ligue1());
                }
                if (t1 == null) {
                    t1 = t;
                } else if (t2 == null) {
